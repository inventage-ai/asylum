...
The image package SHALL generate a project-specific Dockerfile from the packages config and build it when packages are configured.

#### Scenario: No packages configured
- **WHEN** packages config is empty
